    ...
    >
      ...
      <nav className={styles.nav}>
        <ul className={styles.navList}>
          ...
          <li
            className={`${styles.navItem} ${
              location.pathname.includes("/committee") ? styles.active : ""
            }`}
          >
            <NavLink
              to="/committee"
          ...
          <li
            className={`${styles.navItem} ${
              location.pathname.includes("/compliance") ? styles.active : ""
            }`}
          >
            <NavLink
              to="/compliance"
          ...
          <li
            className={`${styles.navItem} ${
              location.pathname.includes("/analytics") ? styles.active : ""
            }`}
          >
            <NavLink
              to="/analytics"

...
import { TrendingUp, TrendingDown, BarChart, CheckCircle, UserCheck, Users, AlertTriangle } from 'lucide-react';
    ...
    <div className={styles.card}>
      ...
      <div className={styles.content}>
        ...
        <div className={`${styles.change} ${isPositive ? styles.positive : styles.negative}`}>
          ...
          <span>{Math.abs(change.value)}% Up {change.timeframe}</span>
        </div>
      </div>
    </div>
  );
